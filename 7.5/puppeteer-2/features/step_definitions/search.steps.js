...
When("user chooses a ticket", async function() {
  ...
  await clickElement(this.page, 'body > main > section:nth-child(3) > div:nth-child(2) > ul > li > a');
  await this.page.waitForSelector('body > main > section > div.buying-scheme > div.buying-scheme__wrapper');
  await clickElement(this.page, 'body > main > section > div.buying-scheme > div.buying-scheme__wrapper > div:nth-child(2) > span:nth-child(1)');
});

Then("the booking button for single ticket should be enabled", async function() {
  const isButtonActive = await isButtonEnabled(this.page, 'body > main > section > button', 'disabled');
...
When("user chooses a few tickets", async function() {
  ...
  await this.page.waitForSelector('body > main > section > div.buying-scheme > div.buying-scheme__wrapper');
  await clickElement(this.page, 'body > main > section > div.buying-scheme > div.buying-scheme__wrapper > div:nth-child(5) > span:nth-child(4)', {timeOut: 10000});
  await clickElement(this.page, 'body > main > section > div.buying-scheme > div.buying-scheme__wrapper > div:nth-child(5) > span:nth-child(5)', {timeOut: 10000});
});
...
When("user chooses a booked ticket", async function() {
  ...
  await this.page.waitForSelector('body > main > section > div.buying-scheme > div.buying-scheme__wrapper');
  await this.page.waitForSelector('body > main > section > div.buying-scheme > div.buying-scheme__wrapper > div:nth-child(10) > span.buying-scheme__chair.buying-scheme__chair_standart.buying-scheme__chair_taken');
});
